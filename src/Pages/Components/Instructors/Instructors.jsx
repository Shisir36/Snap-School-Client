    ...
    return (
       <div>
          <div className="md:h-80 h-20 mt-2 bg-cover" style={{
                ...
                <span className="titles md:text-6xl text-4xl text-white md:absolute md:right-[35%] md:top-36 ml-20 text-center">Our <span className=' text-orange-500'>Instructors</span></span>
            </div>
