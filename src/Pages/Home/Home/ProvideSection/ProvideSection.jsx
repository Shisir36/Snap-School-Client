        ...
        >
            <div className="container mt-28 md:ml-10">
                ...
                <div className="md:flex  md:mt-0 mt-10 md:gap-3 md:ml-0 ml-14">
                    <button className="bg-orange-600 text-gray-50 font-semibold px-14 py-4 rounded-full flex items-center space-x-1 " data-aos="fade-up">
                        <span>Read More</span>
                        <FaArrowRight />
                    </button>
                    <div className="flex items-center space-x-4 md:mt-0 mt-5">
                        <div className='flex items-center space-x-4 ' data-aos="fade-up">
                            <button onClick={openModal} className="bg-white text-orange-600 font-semibold px-6 py-6 rounded-full ml-4 inline-flex items-center" >
                                <FaPlay />
                            </button>
